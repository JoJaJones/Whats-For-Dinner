...
class FirestoreController {
  static final FirestoreController _fsController =
  ...
  Future<void> addEntryToCollection(
      String collection, Map<String, dynamic> data) async {
    _initUser();
    _db.collection(collection).add(data);
  }

  Future<void> addEntryToUserCollection(
      String collection, Map<String, dynamic> data) async {
    _initUser();
    if (userId != null) {
